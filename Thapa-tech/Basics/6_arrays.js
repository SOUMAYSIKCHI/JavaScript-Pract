...
//const abc = arr.forEach( ()=>{} );
// const ans = fruits.forEach(function callback(currentValue,index,array){
//       //your logic here 
// },thisValue);

// const myForEachArr = fruits.forEach((curElem, index, arr) => {
//   return `${curElem} `;  //cant use as it dosnt return
// });

//u cant use return un arr.forEach() only inside that all will be doone 
//console.log(myForEachArr);

// ? 4: map function
//* map() creates a new array from calling a function
//  for every array element. map() does not change the original array.

// const myMapArr = fruits.map((curElem, index, arr) => {
//   return ` my fav fruit is ${curElem} `; //this will return
//   //   console.log(arr);
// });
...
// console.log(b);
// abs.length=0;
// console.log(abs.slice(0,abs.length));
// console.log(abs);
// console.log(b);
