...
// Example:
// var myFavNum = "10";
// console.log(typeof +myFavNum); //another method
// console.log(typeof Number(myFavNum));
// console.log(Number(myfavNum)); //another method
...
//console.log(typeof String(val)); //another method
//console.log(typeof (str+ "")); //another method
...
// console.log(parseInt("xyz"));  this is NAN
// console.log(parseInt("@#$"));  this is also NAN and  pervious line NAN != NAN bcoz both string are diff
